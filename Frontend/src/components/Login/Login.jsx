...
function Login() {
  ...
  return (
    <div className="bg-linear-to-br from-pink-100 via-white to-amber-50 flex flex-row items-center justify-center h-screen max-md:flex-col">
      <div className="flex flex-row items-end justify-center gap-auto max-md:flex-col w-[100%] max-w-5xl max-md:items-center max-md:w-full min-w-[80%] mx-5">
        ...
        <div className="flex flex-col justify-center items-center flex-1 p-8  w-full bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg">
          {getStatus()}
        </div>
      </div>
    </div>
